...
Confirm the deepening stayed inside the three host operations — `.save`'s callers (`session.ts`, `main.ts`) are unchanged — and that nothing S4 built has to be torn out at S5.
